...
import com.college.foodrecipe.adapter.RestaurantMenuAdapter
import com.college.foodrecipe.fragment.FavouritesFragment
import com.college.foodrecipe.fragment.FeedBackFragment
import com.college.foodrecipe.fragment.FoodHomeFragment
import com.college.foodrecipe.fragment.RecipeFragment
import com.college.foodrecipe.fragment.RestaurantFragment
import com.college.foodrecipe.fragment.RestaurantFragment.Companion.resId
import com.college.foodrecipe.fragment.TimerFragment
import com.college.foodrecipe.util.DrawerLocker
import com.college.foodrecipe.util.SessionManager
...
class DashboardActivity : AppCompatActivity(), DrawerLocker {
    ...
    private var isBottomItemSelectedFromOtherFragment = false
...
*/
        bottomNavigationView.setOnItemSelectedListener { item: MenuItem ->
            ...
            if (isBottomItemSelectedFromOtherFragment){
                isBottomItemSelectedFromOtherFragment = false
            ...
            when (item.itemId) {
                ...
                /*Opening the home fragment*/
                R.id.home -> {
                    val homeFragment = FoodHomeFragment()
                    fragmentTransaction.replace(R.id.frame, homeFragment)
                    fragmentTransaction.commit()
                ...
                /*Opening the favorites fragment*/
                R.id.feedback -> {
                    val favFragment = FeedBackFragment()
                    fragmentTransaction.replace(R.id.frame, favFragment)
                    fragmentTransaction.commit()
    ...
    * separate method for it.*/
    ...
    fun setBottomNavigationItem(itemId: Int) {
        isBottomItemSelectedFromOtherFragment = true
